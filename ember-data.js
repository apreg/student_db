    ...
    */
    var RecordArrayManager = Ember.Object.extend({
      init: function() {
        ...
        this.softDeletedRecords = this.softDeletedRecords || Ember.OrderedSet.create();
      },
      ...
      */
      ...
      _recordWasDeleted: function (record) {
        ...
        this.softDeletedRecords.add(record);
      ...
      _recordWasChanged: function (record) {
        ...
        this.softDeletedRecords.remove(record);
...
define("ember-data/lib/system/store",
  ...
  function(__dependency1__, __exports__) {
    ...
    Store = Ember.Object.extend({
        ...
        init: function () {
            ...
            if (!RecordArrayManager) {
                RecordArrayManager = requireModule("ember-data/lib/system/record_array_manager")["default"];
            }
            this.typeMaps = {};
        ...
        allSoftDeleted: function (type) {
            var array = this.recordArrayManager.softDeletedRecords;
    ...
    function deserializeRecordId(store, data, key, relationship, id) {
        if (!Model) {
            Model = requireModule("ember-data/lib/system/model")["Model"];
        }
